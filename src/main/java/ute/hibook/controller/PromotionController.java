...
public class PromotionController {
	...
	public ResponseEntity<PromotionDTO> getPromotionbyID(@PathVariable int idPromotion) {
		PromotionDTO promotionDTOs = promotionServiceImpl.getPromotionById(idPromotion);
		if (promotionDTOs==null) {
			return new ResponseEntity<PromotionDTO>(HttpStatus.NOT_FOUND);
		}
		return new ResponseEntity<PromotionDTO>(promotionDTOs, HttpStatus.OK);
	}
