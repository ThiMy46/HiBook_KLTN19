...
<body>
			...
			<div class="col-md-3">
				<div class="profile-sidebar">
					...
					<div class="profile-usermenu">
						<ul class="nav">
							<li><a href="/HiBookTLCN/info_user/${info.getIdUser()}">
									<span class="glyphicon glyphicon-user"></span> Thông tin
							</a></li>
							<li class="active"><a href="/HiBookTLCN/user_update/${info.getIdUser() }">
									<span class="glyphicon glyphicon-pencil"></span> Quản lý thông
									tin
							</a></li>
							<li><a
								href="/HiBookTLCN/user_bill/${info.getIdUser()}">
											...
											<div class="well">
												...
												<div id="myTabContent" class="tab-content" data-id="${info.getIdUser()}">
													...
													<div class="tab-pane fade" id="profile">
														<div id="tab2">
															<label>Mật khẩu cũ</label> <input type="password" id="passwordold" name="password" placeholder="Nhập mật khẩu cũ" class="form-control"> 
															<label>Mật khẩu mới</label> <input type="password" id="passwordnew" name="password" placeholder="Nhập mật khẩu mới" class="form-control">
															<label>Nhập lại mật khẩu mới</label> <input type="password" id="passwordagain" name="password" placeholder="Nhập lại mật khẩu mới" class="form-control">
															<div>
	...
	<script src="<%=request.getContextPath()%>/resources/js/userupdate.js"></script>
