$(document).ready(function() {
    ...
    $.ajax({
    	...
    	$.each(data, function (i, item) {
    		if(i<4){
    			row1 += '<div class="col-sm-6 col-md-3 tintucHome" style="margin-top: 20px;"><div class="sanpham"><div class="thumbnail entry"><a href="detail/'+item.idBook+'" class="non-textdecoration" target="_blank"><div id="hinh" class="img_center"><img src="resources/images/book/'+item.picBook+'" alt="Nature">'
    			...
    			row2 += '<div class="col-sm-6 col-md-3 tintucHome" style="margin-top: 20px;"><div class="sanpham"><div class="thumbnail entry"><a href="detail/'+item.idBook+'" class="non-textdecoration" target="_blank"><div id="hinh" class="img_center"><img src="resources/images/book/'+item.picBook+'" alt="Nature">'
				+'</div></a></div><div class="h"><span id="NameSP">'+item.nameBook+
				'</span><br/><span style="color: #8a8787; padding: 10px; font-size: 14px;"></span><br/><span style="color: black; padding: 10px; font-size: 14px;">'+(((item.price)*(item.discount))/100)+'đ'+
				'</span><span style="color: grey; padding: 15px; font-size: 12px; text-align: center;"><del>'+(item.price)+'đ'+
				'</del></span><span style="color: red; padding: 16px; font-size: 12px; text-align: right !important;">'+
